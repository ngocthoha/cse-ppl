...
//If Statement
ifStatement:
	IF expression THEN statementList elseIfStatement* (
		ELSE statementList
	)? ENDIF DOT;
elseIfStatement: ELSEIF expression THEN statementList;
//IterationStatement
iterationStatement:
	forStatement
	| whileStatement
...
//While Statement
whileStatement: WHILE expression DO statementList ENDWHILE DOT;
//Do-while Statement
doWhileStatement: DO statementList WHILE expression ENDDO DOT;
//JumpStatement
jumpStatement: breakStatement | continueStatement;
//Break Statement
...
functionCall: Identifier LB argumentList? RB;
